    ...
    return (
        <main className="page">
            <section className="adminNav">
                <button type="button" className="buttonAdminNav" onMouseEnter={() => handleHoverMenu(0)}>Gestion des Rappeurs</button>
                <button type="button" className="buttonAdminNav" onMouseEnter={() => handleHoverMenu(1)}>Gestion des Types</button>
                <button type="button" className="buttonAdminNav" onMouseEnter={() => handleHoverMenu(2)}>Gestion des Faiblesses</button>
            </section>
                ...
                {menuList.map((array, index) => (
                    ...
                    <div className={isShown[index] ? "menuList" : "hidden"}>
                        <Link to={array[0].link_to}>
                            <button type="button" className="buttonAdminMenu">{array[0].text}</button>
                        </Link>
                        <Link to={array[1].link_to}>
                            <button type="button" className="buttonAdminMenu">{array[1].text}</button>
                        </Link><Link to={array[2].link_to}>
                            <button type="button" className="buttonAdminMenu last">{array[2].text}</button>
                        </Link>
                    </div>
                ))}
            </section>
            <img src={Kendrick} alt="background Kendrick Lamar" className="kendrick" style={{ opacity: kendrickOpacity }} />
        </main>
    )
}
